...
urlpatterns = [
    ...
    path('groups/<int:pk>', views.ListCreateGroup.as_view(), name='group-detail'),
    path('groups/<int:pk>/members', views.ListCreateMember.as_view(), name='member-list'),
    path('groups/<int:group_pk>/<int:pk>', views.RetrieveUpdateDestroyMember.as_view(), name='member-detail'),
